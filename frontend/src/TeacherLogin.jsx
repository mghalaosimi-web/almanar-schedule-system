        ...
        <div className="relative z-10 flex items-center gap-3 cursor-pointer" onClick={handleRedirectLogoClick}>
          ...
          <div className="flex flex-col">
            <span className="text-sm font-black tracking-widest uppercase text-white">
              {selectedUniversityName ? selectedUniversityName : (isAr ? 'بوابة الكادر الأكاديمي' : 'FACULTY & STAFF PORTAL')}
            </span>
            <span className="text-[10px] font-bold tracking-wider text-[var(--text-secondary)]">
              {selectedCollegeName ? selectedCollegeName : (isAr ? 'بوابة الكادر الجامعي' : 'University Staff Portal')}
            </span>
          </div>
        </div>
            ...
            >
              ...
              <div className="text-center mb-8 mt-2">
                <p className="text-[10px] font-black tracking-[0.25em] uppercase mb-2" style={{ color: 'var(--accent)' }}>
                  {isAr ? 'الكادر الأكاديمي والإداري' : 'FACULTY & STAFF PORTAL'}
                </p>
              ...
              {pendingLinkEmail ? (
                ...
                <>
                  ...
                  <form onSubmit={handleLogin} className="space-y-5">
                    ...
                    {/* Identifier Input */}
                    <Field label={isAr ? 'البريد الإلكتروني · اسم المستخدم' : 'Email / Username'}>
                      <input
                        type="text"
                        required
                        ...
                        placeholder={isAr ? 'البريد أو اسم المستخدم' : 'Username or email'}
                  ...
                  <div className="mt-6 text-center">
                    ...
                    >
                      {isAr ? 'هل أنت طالب؟ سجل الدخول من بوابة الطلاب' : 'Are you a Student? Login here'}
                    </button>
                  </div>
                </>
              )}
