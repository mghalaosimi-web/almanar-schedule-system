  ...
  return (
    <div className="flex-1 w-full flex items-center justify-center min-h-screen p-0 bg-[#070b13]" dir={isAr ? 'rtl' : 'ltr'}>
      ...
      >
        ...
        <header
          className="bg-[var(--bg-card)]/90 backdrop-blur-xl h-16 flex items-center justify-between px-4 absolute w-full z-40 border-b border-[var(--border-color)] shadow-sm transition-all"
